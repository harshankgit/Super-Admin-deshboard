  ...
  return [
    {
      ...
      documents: ['https://via.placeholder.com/150', 'https://example.com/document.pdf'],
      status: 'active',
...
export const mockGetCustomerById = async (id: number) => {
  ...
  return customers.find(customer => customer._id.includes(id.toString())) || customers[0];
};
...
export const mockChangeCustomerStatus = async (id: number, status: 'active' | 'inactive') => {
  // Simulate API delay
  await new Promise(resolve => setTimeout(resolve, 500));
